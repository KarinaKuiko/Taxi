...
public class PassengerControllerTest {
    ...
    public class findAllTests {
        ...
        void findAll_whenVerifyingRequestMatchingWithoutParams_thenReturn200() throws Exception {
            Page<PassengerReadDto> passengerPage = new PageImpl<>(List.of(defaultPassenger), PageRequest.of(0, 10), 1);
    ...
    public class findByIdTests {
        ...
        void findById_whenValidInput_thenReturn200() throws Exception {
            when(passengerService.findById(DEFAULT_ID)).thenReturn(defaultPassenger);
