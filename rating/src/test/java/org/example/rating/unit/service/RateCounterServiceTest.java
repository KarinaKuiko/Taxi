...
class RateCounterServiceTest {
    ...
    void countRating_whenSingleRating_shouldReturnThatRating() {
        RateReadDto rating = new RateReadDto(1L, 101L,
                "Great ride!", 5, 1001L, UserType.PASSENGER);
    ...
    void countRating_whenMultipleRatings_shouldReturnAverage() {
        RateReadDto rating1 = new RateReadDto(1L, 101L,
                "Great ride!", 5, 1001L, UserType.PASSENGER);
        RateReadDto rating2 = new RateReadDto(2L, 102L,
