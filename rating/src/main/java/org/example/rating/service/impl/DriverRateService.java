...
import static org.example.rating.constants.RedisConstants.DRIVER_RATE_CACHE_VALUE;
...
public class DriverRateService implements RateService {
    ...
    @Override
    @Cacheable(value = DRIVER_RATE_CACHE_VALUE, key = "#id")
    ...
    @Override
    @Transactional
    @CachePut(value = DRIVER_RATE_CACHE_VALUE, key = "#result.id()")
    ...
    @Override
    @Transactional
    @CachePut(value = DRIVER_RATE_CACHE_VALUE, key = "#id")
