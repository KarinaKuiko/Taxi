...
import static org.example.driver.constants.SecurityConstants.EMAIL_CLAIM;
...
public class AccessValidator {
    ...
    @Around("@annotation(org.example.driver.annotation.ValidateAccess)")
    public Object validateAccess(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (!Objects.equals(driverService.findById(driverId).email(),
