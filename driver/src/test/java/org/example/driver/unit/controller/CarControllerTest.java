...
public class CarControllerTest {
    ...
    @BeforeEach
    void init() {
        defaultCar = new CarReadDto(1L, "red", "BMW", "AB123CD", 2023, List.of());
    ...
    void findAll_whenCorrectParams_thenReturn200() throws Exception {
        when(carService.findAll(1, 20)).thenReturn(carPage);
    ...
    void findById_whenVerifyingRequestMatching_thenReturn200() throws Exception {
        when(carService.findById(1L)).thenReturn(carList.get(0));
    ...
    void create_whenVerifyingRequestMatching_thenReturn200() throws Exception {
        CarCreateEditDto carCreate = new CarCreateEditDto("yellow", "Peugeot", "LK124AS", 2014);

        mockMvc.perform(post(URL)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(carCreate)))
    ...
    void create_whenValidInput_thenReturn201AndCarReadDto() throws Exception {
        CarCreateEditDto carCreate = new CarCreateEditDto("yellow", "Peugeot", "LK124AS", 2014);
        CarReadDto carReadDto = new CarReadDto(3L, "yellow", "Peugeot", "LK124AS", 2014, List.of());

        when(carService.create(carCreate)).thenReturn(carReadDto);
        ...
        assertThat(actualResponseBody).isEqualToIgnoringWhitespace(
                objectMapper.writeValueAsString(carReadDto));
    }

    @Test
    void create_whenInvalidInput_thenReturn400AndValidationResponse() throws Exception {
        CarCreateEditDto carCreate = new CarCreateEditDto(null, null, null, 2026);
    ...
    void create_whenInvalidInputWithPattern_thenReturn400AndValidationResponse() throws Exception {
        CarCreateEditDto carCreate = new CarCreateEditDto(null, null, "45sdsaassa", 1900);
    ...
    void update_whenValidInput_thenReturn200AndCarReadDto() throws Exception {
        CarCreateEditDto carCreate = new CarCreateEditDto("yellow", "Peugeot", "LK124AS", 2014);
        CarReadDto carReadDto = new CarReadDto(DEFAULT_ID, "yellow", "Peugeot", "LK124AS", 2014, List.of());

        when(carService.update(DEFAULT_ID, carCreate)).thenReturn(carReadDto);
